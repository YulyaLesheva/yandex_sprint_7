...
class TestCourierCreation:
    ...
    def test_create_courier(self):
        ...
        request = APIClient.register(payload)
    ...
    def test_courier_conflict(self, register_new_courier_and_return_login_password):
        ...
        copied_courier_request = APIClient.register(initial_courier_request)
        copied_courier_parsed_text = Parser.parse_response_text(copied_courier_request)
    ...
    def test_empty_required_fields_fail_registration(self, empty_param):
        ...
        request = APIClient.register(payload)
        parsed_request_text = Parser.parse_response_text(request)
